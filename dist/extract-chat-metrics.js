...
// Constants
const CLAUDE_LOGS_DIR = "/Users/ktalebian/Library/Application Support/Code/User/globalStorage/saoudrizwan.claude-dev/tasks";
...
async function processDirectory(dir, modelArg, clientArg, serverArg) {
    try {
        ...
        return {
            metrics: [],
            error: `Error processing ${path.basename(dir)}: ${error.message}`,
        };
    }
}
// Run the extraction
